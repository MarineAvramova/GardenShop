...
*/
    ...
    public static void createTree(Connection connection, String name, double price, double height) {

        String insertTree = "INSERT INTO products (name, type, price, height) VALUES ('" + name + "',0, " + price + ", " + height + ");";
        Statement st;
        try {
            st = connection.createStatement();
    ...
    public static void createFlower(Connection connection, String name, double price, String color) {
        String insertFlower = "INSERT INTO products (name, type, price, color) VALUES ('" + name + "',1, " + price + ", '" + color + "');";
        Statement st;
        try {
            st = connection.createStatement();
    ...
    public static void createDecor(Connection connection, String name, double price, String material) {

        String insertDecor = "INSERT INTO products (name, type, price, material) VALUES ('" + name + "',2, " + price + ", '" + material + "');";
        Statement st;
        try {
            st = connection.createStatement();
