...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            System.out.println("0 - Create Flower Shop");
    ...
    private static void createFlowerShop(Scanner scanner) {
        ...
        SQL.createGardenShop (connection,floristName);
    }
    private static void addTree(Scanner scanner) {
        ...
        Connection connection=SQL.connectDB();
        SQL.createTree(connection, name, price, height);
    }
